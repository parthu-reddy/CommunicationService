package com.fooddelivery.contract.consumer.chat.listener;
...
public class RefundDecisionListenerTest {
    ...
    public void testConsumerIsWorking() {
        try {
            stubTrigger.trigger("trigger-chat-event");
        } catch (Exception e) {
